...
export interface UserChangeStatusDialogData {
  user: UserDto;
}

@Component({
  selector: 'app-user-change-status-dialog',
  templateUrl: './change-status-dialog.component.html',
  styleUrls: ['./change-status-dialog.component.scss'],
  standalone: false
})
export class UserChangeStatusDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<UserChangeStatusDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: UserChangeStatusDialogData
  ) {
    this.user = data.user;
